      ...
      <Card className="form-card" style={{backgroundColor:'black',width:'100vw',height:'100vh'}}>
        <CardBody style={{backgroundColor:'black',width:'100%'}}>
          ...
          <div className="my-3 form-group">
            ...
            <div className="my-3 form-group">
              <Label for="title" className="form-label">Rent</Label>
              <Input type="text"  onChange={e=>setrent(e.target.value)}  id="title" placeholder="Enter here" className="rounded-0 form-input" name="title" />
            </div>
            <div className="my-3 form-group" style={{display:'flex',justifyContent:'space-between'}}>
            <div style={{width:'30%'}} >
            ...
            <div className="my-3 form-group" style={{display:'flex',justifyContent:'space-between'}}>
            <div style={{width:'45%'}} >
              <Label for="title" className="form-label">Subscription Type</Label>
              <Input type="select" onChange={e=>setsubscript(e.target.value)} id="rooms" placeholder="Enter here" className="rounded-0 form-input" name="rooms">
              <option value="" selected disabled hidden>Choose here</option>
                <option value="0-6k-(500/-)">0-6k-(500/-)</option>
                <option value="6-15k-(800/-)">6-15k-(600/-)</option>
                <option value="15-25k-(800/-)">15-25k-(800/-)</option>
                <option value="25-50k-(1200/-)">25-50k-(1200/-)</option>
                <option>others</option>
              </Input>
            </div>
            <div style={{width:'45%'}} >
              <Label for="title" className="form-label">Comments by Analyst  (if Any)</Label>
